...
collection: teaching
type: "Project Mentor, Undergraduate Project"
 ...
 * Project topics
   * Doppler Radar Displacement Measurements (Fall 2012, 2 students)
   * Doppler Radar Sensing of Vital Signs (Spring 2013, 3 students)
   * Human Torso Optical Positioning (Spring 2014, 2 students).
